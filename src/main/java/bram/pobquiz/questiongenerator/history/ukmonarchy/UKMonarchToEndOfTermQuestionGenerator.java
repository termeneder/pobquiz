...
public class UKMonarchToEndOfTermQuestionGenerator {

	private UKMonarchs c_ukMonarchs;
	private QuestionList c_questionList;
	
	public UKMonarchToEndOfTermQuestionGenerator(UKMonarchs ukMonarchs,
	...
	private void addFactory(Monarch monarch, List<QuestionFactory> factoryList) {
		...
		if (sameFactory == null) {
			...
			newFactory.withCaterorgy("Monarch to end of term");
	...
	private String makeQuestion(Monarch monarch) {
		String question = "When did " + monarch.name + " cease to be";
