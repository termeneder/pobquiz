...
public class MostIncorrectQuestionsAnalysis extends RankingAnalysis {

	public MostIncorrectQuestionsAnalysis(int top) {
		super(top);
	}
	...
	protected String getDescription() {
		...
		return "Questions most commonly answered incorrectly";
	}
